...
placeGamePiece('T', 'white', { level: 5, rank: 3, file: 1 });
placeGamePiece('T', 'white', { level: 2, rank: 7, file: 1 });
placeGamePiece('T', 'black', { level: 1, rank: 4, file: 1 });
placeGamePiece('T', 'black', { level: 5, rank: 7, file: 3 });
